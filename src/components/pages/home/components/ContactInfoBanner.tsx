  ...
  const contactMethods = [
    {
      ...
      icon: FaWhatsapp,
      link: "https://wa.me/573214024276?text=Hola%20MC%20Contadores,%20estoy%20interesado%20en%20sus%20servicios.",
      color: "hover:bg-green-500 hover:text-white hover:border-green-500",
      iconColor: "text-green-500",
    },
    {
      title: "Líneas de Atención",
      desc: "318 260 0651 / 321 402 4276",
      icon: FaPhoneAlt,
      link: "tel:+573214024276",
      color: "hover:bg-color-navy hover:text-white hover:border-color-navy",
      iconColor: "text-color-navy",
    },
    {
      title: "Correo Electrónico",
      desc: "mc.contadorescol@gmail.com",
      icon: FaEnvelope,
      link: "mailto:mc.contadorescol@gmail.com",
