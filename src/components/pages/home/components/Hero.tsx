      ...
      <div className="container mx-auto px-4 md:px-8 z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2 flex flex-col items-start text-left">
            ...
            >
              Contabilidad estratégica y <span className="text-color-gold">crecimiento</span> <span className="text-color-gold relative inline-block">
                sostenible
                <AnimatedUnderline />
              </span>
            </motion.h1>
            ...
            >
              MC Contadores COL S.A.S. ofrece soluciones integrales bajo los más altos estándares de calidad, ética profesional y cumplimiento normativo.
            </motion.p>
